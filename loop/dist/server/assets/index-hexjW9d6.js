  ...
  let adapterCreator = createAdapterFactory({
    config: {
      ...
      customTransformInput(props) {
        var _a, _b, _c, _d;
        if ((((_b = (_a = props.options.advanced) == null ? void 0 : _a.database) == null ? void 0 : _b.useNumberId) || ((_d = (_c = props.options.advanced) == null ? void 0 : _c.database) == null ? void 0 : _d.generateId) === "serial") && props.field === "id" && props.action === "create") return db[props.model].length + 1;
        return props.data;
      },
    ...
    adapter: ({ getFieldName, options, getModelName }) => {
      ...
      return {
        create: async ({ model, data }) => {
          var _a, _b, _c, _d;
          if (((_b = (_a = options.advanced) == null ? void 0 : _a.database) == null ? void 0 : _b.useNumberId) || ((_d = (_c = options.advanced) == null ? void 0 : _c.database) == null ? void 0 : _d.generateId) === "serial") data.id = db[getModelName(model)].length + 1;
