...
import { u as useSession, s as signIn } from "./auth-client-BREKG5Fm.js";
import { toast } from "sonner";
import { ArrowLeft, ArrowRight, CheckCircle, ShieldOff, FileX2, Ban, Car, ArrowLeftRight, CreditCard, Unlock, ShieldCheck, Check, Star, ChevronDown } from "lucide-react";
import "./router-CZNYi4nd.js";
...
function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.error) {
        ...
        const user = (_a = result.data) == null ? void 0 : _a.user;
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex min-h-screen flex-col bg-[#f2f2f0]", children: [
    /* @__PURE__ */ jsx("header", { className: "px-4 py-6", children: /* @__PURE__ */ jsxs("a", { href: "https://driivo.fr", className: "inline-flex items-center gap-2 text-sm text-gray-500 hover:text-[#fd521a]", children: [
    ...
    /* @__PURE__ */ jsx("main", { className: "flex flex-1 items-center justify-center px-4", children: /* @__PURE__ */ jsxs("div", { className: "w-full max-w-md", children: [
      /* @__PURE__ */ jsxs("div", { className: "mb-8 text-center", children: [
        /* @__PURE__ */ jsx("a", { href: "https://driivo.fr", className: "inline-block", children: /* @__PURE__ */ jsx("div", { className: "mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-[#fd521a]", children: /* @__PURE__ */ jsx("div", { className: "h-3 w-3 rounded-full bg-white" }) }) }),
        /* @__PURE__ */ jsx("h1", { className: "mb-2 text-2xl font-bold text-[#1c1917]", children: "Connexion" }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-600", children: "Accédez à votre espace Driivo" })
      ] }),
      /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { htmlFor: "email", className: "mb-1 block text-sm font-medium text-[#1c1917]", children: "Email" }),
          /* @__PURE__ */ jsx("input", { id: "email", type: "email", value: email, onChange: (e) => setEmail(e.target.value), placeholder: "votre@email.com", className: "w-full rounded-lg border border-gray-200 bg-white px-4 py-3 text-[#1c1917] placeholder:text-gray-400 focus:border-[#fd521a] focus:outline-none focus:ring-2 focus:ring-[#fd521a]/20", required: true })
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { htmlFor: "password", className: "mb-1 block text-sm font-medium text-[#1c1917]", children: "Mot de passe" }),
          /* @__PURE__ */ jsx("input", { id: "password", type: "password", value: password, onChange: (e) => setPassword(e.target.value), placeholder: "••••••••", className: "w-full rounded-lg border border-gray-200 bg-white px-4 py-3 text-[#1c1917] placeholder:text-gray-400 focus:border-[#fd521a] focus:outline-none focus:ring-2 focus:ring-[#fd521a]/20", required: true })
        ] }),
        /* @__PURE__ */ jsx("button", { type: "submit", disabled: isLoading, className: "w-full rounded-lg bg-[#fd521a] px-4 py-3 font-bold text-white transition-colors hover:bg-[#e04819] disabled:cursor-not-allowed disabled:opacity-50", children: isLoading ? "Connexion..." : "Se connecter" })
      ] }),
      /* @__PURE__ */ jsxs("p", { className: "mt-6 text-center text-sm text-gray-600", children: [
        "Pas encore inscrit ?",
        " ",
        /* @__PURE__ */ jsx("a", { href: "https://app.driivo.fr/inscription", className: "font-medium text-[#fd521a] hover:underline", children: "Rejoindre Driivo" })
      ] })
    ] }) })
  ] });
}
function LandingPage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#f2f2f0] text-[#1c1917] selection:bg-[#fd521a] selection:text-white", style: {
    ...
    /* @__PURE__ */ jsx("nav", { className: "fixed left-0 top-6 z-50 flex w-full justify-center px-4", children: /* @__PURE__ */ jsxs("div", { className: "flex max-w-3xl items-center gap-8 rounded-full border border-white/40 bg-white/60 px-3 py-2 pl-6 shadow-[0_8px_32px_-4px_rgba(168,162,158,0.1),inset_0_0_0_1px_rgba(255,255,255,0.5)] backdrop-blur-2xl", children: [
      ...
      /* @__PURE__ */ jsx("a", { href: "https://app.driivo.fr/inscription", className: "rounded-full bg-[#111] px-5 py-2 text-xs font-bold tracking-wide text-white shadow-[0_8px_20px_-4px_rgba(0,0,0,0.2)] transition-all hover:-translate-y-0.5 hover:bg-[#fd521a] hover:shadow-[0_12px_28px_-4px_rgba(253,82,26,0.4)]", children: "REJOINDRE" })
    ] }) }),
    /* @__PURE__ */ jsxs("main", { className: "relative z-10 mx-auto max-w-[1040px] px-4 pt-32 md:px-8 md:pt-40", children: [
      ...
      /* @__PURE__ */ jsx("section", { id: "simulateur", className: "mb-10 py-8", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-2xl rounded-[2.5rem] border border-white/50 bg-gradient-to-br from-white/80 to-[#fafaf9]/60 p-8 shadow-[0_20px_40px_-12px_rgba(168,162,158,0.15)] backdrop-blur-3xl md:p-10", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3 sm:flex-row sm:justify-center", children: [
          ...
          /* @__PURE__ */ jsx("a", { href: "https://app.driivo.fr/inscription", className: "flex items-center justify-center gap-2 rounded-full border border-gray-200 bg-white px-6 py-3 text-sm font-bold transition-all hover:-translate-y-0.5 hover:border-[#fd521a] hover:text-[#fd521a]", children: "Rejoindre maintenant" })
        ] })
      ] }) }),
      ...
      /* @__PURE__ */ jsxs("section", { className: "py-16", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "mt-10 text-center", children: /* @__PURE__ */ jsxs("a", { href: "https://app.driivo.fr/inscription", className: "inline-flex items-center gap-2 rounded-full bg-[#fd521a] px-8 py-4 text-base font-bold text-white shadow-[0_8px_20px_-4px_rgba(253,82,26,0.3)] transition-all hover:-translate-y-0.5 hover:bg-[#e0410e]", children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "py-20", children: /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden rounded-[3rem] border border-white/50 bg-gradient-to-br from-white/70 to-[#fafaf9]/50 p-12 text-center shadow-[0_20px_40px_-12px_rgba(168,162,158,0.15)] backdrop-blur-3xl", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative z-10", children: [
          ...
          /* @__PURE__ */ jsx("a", { href: "https://app.driivo.fr/inscription", className: "inline-block rounded-full bg-[#fd521a] px-10 py-4 text-lg font-bold text-white shadow-xl transition-transform hover:scale-105", children: "Je me lance" })
        ] })
      ] }) }),
