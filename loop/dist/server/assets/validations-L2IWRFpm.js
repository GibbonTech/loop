...
const phoneSchema = z.string().min(1, "Le téléphone est requis").regex(phoneRegex, "Numéro de téléphone invalide");
const emailSchema = z.string().min(1, "L'email est requis").email("Adresse email invalide");
const nameSchema = z.string().min(2, "Minimum 2 caractères").max(50, "Maximum 50 caractères");
const simulateurFormSchema = z.object({
  prenom: nameSchema,
  email: emailSchema,
...
export {
  reunionFormSchema as r,
  simulateurFormSchema as s,
  validateForm as v
};
