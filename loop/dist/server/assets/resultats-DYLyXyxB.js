...
import { R as Route } from "./router-B5L6HemN.js";
import "sonner";
...
function ResultatsPage() {
  ...
  const aeNet = Math.round(ca * 0.75);
    ...
    /* @__PURE__ */ jsxs("main", { className: "mx-auto max-w-[900px] px-4 pb-20 pt-32 md:px-8", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "mb-8 rounded-[2.5rem] border border-white/60 bg-white/50 p-8 shadow-lg backdrop-blur-sm md:p-12", children: [
        /* @__PURE__ */ jsxs("div", { className: "mb-10 text-center", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-gray-400", children: "Après cotisations sociales et frais Loop" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "mb-8 rounded-2xl border border-white bg-white/60 p-6", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsx("span", { className: "text-sm text-gray-600", children: "Frais Loop (10%)" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-gray-100 bg-gray-50 p-6", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid gap-4 md:grid-cols-2", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-[#fd521a]/20 bg-[#fd521a]/5 p-4", children: [
              /* @__PURE__ */ jsx("div", { className: "mb-2 text-xs font-bold text-[#fd521a]", children: "Avec Loop" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "rounded-[2rem] border border-white/60 bg-white/50 p-8 text-center shadow-lg backdrop-blur-sm", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col justify-center gap-4 sm:flex-row", children: [
          /* @__PURE__ */ jsxs(Link, { to: "/inscription", className: "flex items-center justify-center gap-2 rounded-full bg-[#fd521a] px-8 py-4 text-base font-bold text-white shadow-lg transition-all hover:-translate-y-0.5 hover:shadow-xl", children: [
            "C'est parti",
            /* @__PURE__ */ jsx(ArrowRight, { className: "h-5 w-5" })
          ] }),
          /* @__PURE__ */ jsxs(Link, { to: "/reunion", className: "flex items-center justify-center gap-2 rounded-full bg-[#111] px-8 py-4 text-base font-bold text-white shadow-lg transition-all hover:-translate-y-0.5 hover:bg-[#fd521a]", children: [
            "J'ai des questions",
