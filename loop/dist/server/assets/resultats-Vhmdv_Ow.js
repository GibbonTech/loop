...
import { R as Route } from "./router-Ba_068gO.js";
import "clsx";
import "sonner";
...
function ResultatsPage() {
  ...
  const {
    ...
    cotisations,
    net
  } = getSalaryBreakdown(caNum);
  const aeNet = Math.round(caNum * 0.75);
  return /* @__PURE__ */ jsxs(PageLayout, { navbarVariant: "minimal", showNavLinks: false, children: [
    /* @__PURE__ */ jsxs("main", { className: "mx-auto max-w-[900px] px-4 pb-20 pt-32 md:px-8", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "rounded-[2rem] border border-white/50 bg-gradient-to-br from-white/70 to-[#fafaf9]/50 p-8 text-center shadow-[0_20px_40px_-12px_rgba(168,162,158,0.15),inset_0_1px_0_0_rgba(255,255,255,0.8)] backdrop-blur-3xl", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col justify-center gap-4", children: [
          /* @__PURE__ */ jsxs(Link, { to: "/inscription", className: "flex items-center justify-center gap-2 rounded-full bg-[#fd521a] px-8 py-4 text-lg font-bold text-white shadow-[0_8px_20px_-4px_rgba(253,82,26,0.3)] transition-all hover:-translate-y-0.5 hover:bg-[#e0410e] hover:shadow-[0_12px_28px_-4px_rgba(253,82,26,0.4)]", children: [
            "Rejoindre Driivo maintenant",
            /* @__PURE__ */ jsx(ArrowRight, { className: "h-5 w-5" })
          ] }),
          /* @__PURE__ */ jsxs(Link, { to: "/reunion", className: "flex items-center justify-center gap-2 text-sm font-medium text-gray-500 transition-colors hover:text-[#fd521a]", children: [
